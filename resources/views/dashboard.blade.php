        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <p class="font-bold text-xl">{{ __("Welcome, ") . auth()->user()->name }} @can('admin') (Admin) @endcan</p>
                    ...
                    <div class="container my-24 px-6 mx-auto">
                        ...
                        <section class="mb-32 text-gray-800 text-center dark:text-whites">
                            <h2 class="text-3xl font-bold mb-20 dark:text-white">Resource Stats</h2>
                            ...
                            <div class="mb-12 lg:mb-0">
                                ...
                                <div class="p-6">
                                    <h3 class="text-2xl font-bold text-blue-600 mb-4">{{ $books->count() }}</h3>
                            ...
                            <div class="mb-12 lg:mb-0">
                                ...
                                <div class="p-6">
                                    <h3 class="text-2xl font-bold text-blue-600 mb-4">{{ $requests->count() }}</h3>
                                    <h5 class="text-lg font-medium mb-4">Book Rentage Requests (Pending)</h5>
                                    <p class="text-gray-500">
                                        Total number of book requests that on are pending
                                    </p>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="">
                                ...
                                <div class="p-6">
                                    <h3 class="text-2xl font-bold text-blue-600 mb-4">{{ $users->count() }}</h3>
                                    <h5 class="text-lg font-medium mb-4">Total Customers</h5>
                                    <p class="text-gray-500">
