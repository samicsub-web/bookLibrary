                    ...
                    <form wire:submit.prevent="submit" class="mt-6 space-y-6">
                        ...
                        <div class="flex md:flex-row md:justify-between md:gap-5">
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="cover_photo" wire:model="cover_photo" type="file" class="mt-1 block w-full" required autofocus autocomplete="cover_photo" />
                        ...
                        <div class="flex md:flex-row md:justify-between md:gap-5">
                            ...
                            <div class="w-full">
                                <x-input-label  :value="__('Book File Type')" />
                                <x-input-select wire:model="file_type">
                                    <option selected disabled>Select File Type</option>
                                    @foreach ($book_file_types as $key => $file_type)
                                        <option value="{{ $file_type }}">{{ $key }}</option>
                                    @endforeach
                                </x-input-select>
                        ...
                        <div class="flex md:flex-row md:justify-between md:gap-5">
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="file" wire:model="file" type="file" class="mt-1 block w-full" required  />
